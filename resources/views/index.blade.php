            ...
            <div class="container mx-auto px-6">
                <div class="max-w-4xl mx-auto">
                    ...
                    <div class="bg-white rounded-2xl shadow-2xl p-8 md:p-12">
                        <form action="{{ route('contact.form.submit') }}" method="POST" class="space-y-8" onsubmit="formSubmit()">
                            @csrf
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
                                <div class="relative">
                                    <input type="text" name="name" id="name" class="peer w-full border-b-2 border-gray-300 text-gray-900 focus:border-purple-600 focus:outline-none placeholder-transparent py-2" value="{{ old('name') ?? '' }}" placeholder="Your Name" required>
                                    @error('name')
                                ...
                                <div class="relative">
                                    <input type="email" name="email" id="email" class="peer w-full border-b-2 border-gray-300 text-gray-900 focus:border-purple-600 focus:outline-none placeholder-transparent py-2" value="{{ old('email') ?? '' }}" placeholder="Email Address" required>
                                    @error('email')
                                        <x-input-error :message="$message" />
                                    @enderror
                            ...
                            <div class="relative">
                                <textarea name="message" id="message" rows="4" class="peer w-full border-b-2 border-gray-300 text-gray-900 focus:border-purple-600 focus:outline-none placeholder-transparent py-2" placeholder="Your Message" required>{{ old('message') ?? '' }}</textarea>
                                @error('message')
                                    <x-input-error :message="$message" />
                                @enderror
                    ...
                    <div class="mt-16 grid grid-cols-1 md:grid-cols-3 gap-8 text-center">
                        <div class="p-6">
                            <a href="mailto:contact@hasib.info" class="w-12 h-12 animate-bounce bg-purple-100 rounded-full flex items-center justify-center mx-auto mb-4">
                        ...
                        <div class="p-6">
                            <a href="tel:+8801965046625" class="w-12 h-12 animate-bounce bg-purple-100 rounded-full flex items-center justify-center mx-auto mb-4">
                                <svg class="w-6 h-6 text-purple-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
